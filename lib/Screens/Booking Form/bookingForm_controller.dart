...
class BookingFormController extends AppBaseController {
  ...
  Future<void> BookGround() async {
    var param = {
      ...
      'booking_time_from': selectTimeFrom.toString().split(':').first.length == 2 ?selectTimeFrom.toString() : '${selectTimeFrom.toString()}',
      'booking_time_to': selectTimeTo.toString().split(':').first.length == 2 ?  selectTimeTo.toString() : '${selectTimeTo.toString()}',
